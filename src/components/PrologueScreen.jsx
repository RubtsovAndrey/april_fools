...
export default function PrologueScreen({ onComplete }) {
  ...
  const lines = [
    ...
    'Назад дороги нет.',
    'Жребий брошен.',
    'Моцарелла разморожена.',
    'За проезд уже передали',
    '—',
    'Перед вами — маленькая пиццерия в Сыктывкаре.',
    'Четыре показателя определят, как далеко вы сможете зайти:',
    ...
    'Если игра покажется сложной, то на стартовом экране есть читы',
    'Удачи, CEO.',
  ]
